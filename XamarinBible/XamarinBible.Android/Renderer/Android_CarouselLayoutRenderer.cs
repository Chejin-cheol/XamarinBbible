...
[assembly: ExportRenderer(typeof(CarouselLayout), typeof(Android_CarouselLayoutRenderer))]
namespace XamarinBible.Droid.Renderer
{
    class Android_CarouselLayoutRenderer : ScrollViewRenderer
    {
        int _prevScrollX;
        int _deltaX;
        bool _motionDown;
        ...
        public Android_CarouselLayoutRenderer(Context context) : base(context)
        {
        }
