...
[assembly: ExportRenderer(typeof(PlatformSlider), typeof(Android_PlatformSliderRenderer))]
namespace XamarinBible.Droid.Renderer
{
    public class Android_PlatformSliderRenderer : SliderRenderer
    {
        public Android_PlatformSliderRenderer(Context context) : base(context)
        {
